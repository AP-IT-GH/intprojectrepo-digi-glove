...
def update(): #to edit in release
       ...
       if(ser1.inWaiting() >= 62):
            ...
            # timeByteArray = bytearray([data_seq[8], data_seq[9], data_seq[10], data_seq[11], data_seq[12], 
                # data_seq[13], data_seq[14], data_seq[15]])

            # data["Time"] = struct.unpack('<f', timeByteArray)[0]
...
#wByteArray = bytearray(wBytes)
            wByteArray = bytearray([data_seq[24], data_seq[25], 0, 0])
            data["W"] = struct.unpack('i', wByteArray)[0]
            
            data["W2"] = struct.unpack('f', wByteArray)[0]
            ...
            print(data["W"], "Fingers: ", data["IndexF_0"], data["IndexF_1"], data["MiddleF_0"], data["MiddleF_1"], 
                data["RingF_0"], data["RingF_1"], data["LittleF_0"], data["LittleF_1"], data["Thumb_0"], data["Thumb_1"], 
                "Tips: ", data["IndexF_tip"], data["MiddleF_tip"], data["RingF_tip"], data["LittleF_tip"])
